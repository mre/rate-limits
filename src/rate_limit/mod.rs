//! Rate limit headers as defined in [RFC
//! 6585](https://tools.ietf.org/html/rfc6585) and
//! [draft-polli-ratelimit-headers-00][draft] as well as other common
//! innofficial rate limit header formats from various vendors.
